...
import { GrantForm, UiInstruction } from '../../../utils/vote/uiTypes/proposalCreationTypes'
...
import { lockupTypes } from '../../tools/types'
import { getFormattedStringFromDays } from '../../tools/dateTools'
import * as yup from 'yup'
import { getGrantInstruction } from '../../actions/getGrantInstruction'
import { getRegistrarPDA } from '../../sdk/accounts'
import { tryGetRegistrar } from '../../sdk/api'
import useVotePluginsClientStore from '../../../stores/vote/useVotePluginsClientStore'
import dayjs from 'dayjs'
import { getAccountName } from '../../../components/views/dao/instructions/tools'
...
import ToggleSwitch from '../../../components/views/elements/ToggleSwitch'
    ...
    <>
      ...
      >
        {lockupTypes.map((lockup, idx) => {
          return (
            <option key={idx} value={lockup.displayName}>
              {lockup.displayName}
            </option>
          )
        })}
