...
import { voteRegistryLockDeposit } from '../../actions/voteRegistryLockDeposit'
import { DepositWithMintAccount } from '../../sdk/accounts'
import {
  yearsToDays,
  daysToMonths,
...
import { voteRegistryStartUnlock } from '../../actions/voteRegistryStartUnlock'
import {
  LockupKind,
  lockupTypes,
  MONTHLY,
...
import { calcMintMultiplier } from '../../tools/deposits'
import { getMintMetadata } from '../../../components/views/dao/instructions/programs/splToken'
import InlineNotification from '../../../components/views/dao/InlineNotification'
...
const LockTokensModal = ({
          ...
          <>
            ...
            <div className="mb-4">
              ...
              <div className={`${labelClasses} flex items-center`}>
                ...
                {lockupType.value !== CONSTANT ? (
                  <Tooltip label="The multiplier will decline linearly over time">
  ...
  return (
    // <div onClose={onClose} isOpen={isOpen}>
    <div>
      {currentStep !== 1 ? (
