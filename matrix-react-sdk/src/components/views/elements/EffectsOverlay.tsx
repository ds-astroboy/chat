...
const EffectsOverlay: FunctionComponent<IProps> = ({ roomWidth, isHomePage }) => {
    ...
    useEffect(() => {
        ...
        const onAction = (payload: { action: string, isHomePage?: boolean }) => {
            if(isHomePage && !payload.isHomePage) return;
