...
export default class Field extends React.PureComponent<PropShapes, IState> {
    ...
    public render() {
        ...
        const { element, prefixComponent, postfixComponent, className, onValidate, children,
            tooltipContent, forceValidity, tooltipClassName, list, validateOnBlur, validateOnChange, validateOnFocus, maxLength,
        ...
        const inputProps_ = { ...inputProps, ref, list, maxLength };
