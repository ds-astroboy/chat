...
interface IProps {
    ...
    className?: string;
    // The value for the tooltip when mouseover toggle switch.
    tooltipLabel?: string;
...
export default class LabelledToggleSwitch extends React.PureComponent<IProps> {
    render() {
        ...
        let Button: React.ComponentType<React.ComponentProps<typeof AccessibleTooltipButton>> = AccessibleTooltipButton;
