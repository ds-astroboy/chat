...
export default class Tooltip extends React.Component<IProps> {
    ...
    public transformHorizontalCenter = "translate(-50%, 0)";
    public transformCenter = "translate(-50%, -110%)";
    ...
    private updatePosition(style: CSSProperties) {
        ...
        switch (this.props.alignment) {
            ...
            case Alignment.Top:
                ...
                style.transform = this.transformCenter;
                break;
            case Alignment.Bottom:
                style.top = baseTop + parentBox.height;
                style.left = horizontalCenter;
                style.transform = this.transformHorizontalCenter;
                break;
        }
