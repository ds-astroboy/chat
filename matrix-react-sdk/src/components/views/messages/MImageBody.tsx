...
export default class MImageBody extends React.Component<IBodyProps, IState> {
    ...
    render() {
        ...
        if (this.state.error !== null) {
            return (
                <span className="mx_MImageBody"  onContextMenu={this.props.showMessageActionBar}>
        ...
        return <span className="mx_MImageBody" onContextMenu={this.props.showMessageActionBar}>
