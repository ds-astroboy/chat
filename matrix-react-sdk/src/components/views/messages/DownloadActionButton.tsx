...
interface IProps {
    ...
    setIsShowMessageActionBar: (value: boolean) => void;

    isClickActionBar?: boolean
}
...
export default class DownloadActionButton extends React.PureComponent<IProps, IState> {
    ...
    public render() {
        ...
        const iconClassName = classNames({
            "mx_IconizedContextMenu_icon": true,
            "mx_MessageContextMenu_iconDownload": true,
            "mx_MessageContextMenu_iconDownloadSpinner": !!spinner
        })

        if(this.props.isClickActionBar) {
            return (
                <AccessibleButton
                ...
                >
                    ...
                    <span className="mx_IconizedContextMenu_label">
                        {spinner ? _t("Downloading") : _t("Download")}
                    </span>
                </AccessibleButton>   
            )
        }
