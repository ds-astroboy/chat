...
export default class MessageEvent extends React.Component<IProps> implements IMediaBody, IOperableEventTile {
    ...
    private get bodyTypes(): Record<string, React.Component> {
        return {
            ...
            [MsgType.GIF]: sdk.getComponent('messages.MGIFBody'),
    ...
    public render() {
        ...
        return BodyType ? <BodyType
            ...
            senderAndGift={this.props.senderAndGift? this.props.senderAndGift : null}
            giftsRow={this.props.giftsRow}
            showMessageActionBar={this.props.showMessageActionBar}
