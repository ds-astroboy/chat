 ...
 */
 ...
 export default class SenderProfile extends React.Component<IProps, IState> {
     ...
     render() {
         ...
         const name = MatrixClientPeg.get().getUser(senderId)?.displayName;
         const disambiguate = mxEvent.sender?.disambiguate;
         let displayName = name || mxEvent.getSender() || "";
         ...
         // const isVerified = checkVerifiedUserOrRoom(mxEvent.getSender(), displayName);
         // let verifiedBadge;
         // if(isVerified) {
         ...
         return (
             <div className="mx_SenderProfile" dir="auto" onClick={this.props.onClick}>
                 <VerifiedCheckContainer isUser={true} className={nameClassName} id={mxEvent.getSender()} roomId={roomId}>
                     {
                         this.props.isPreview?
                         displayName
                         :
                         <DomainNameCheckContainer userId={senderId} >
                             { displayName }
