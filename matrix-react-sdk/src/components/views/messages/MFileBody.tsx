    ...
    public render() {
        ...
        if (isEncrypted) {
            if (!this.state.decryptedBlob) {
                ...
                return (
                    <span className="mx_MFileBody" onContextMenu={this.props.showMessageActionBar}>
            ...
            return <span className="mx_MFileBody" onContextMenu={this.props.showMessageActionBar}>
                { this.props.actionBar }
                { placeholder }
