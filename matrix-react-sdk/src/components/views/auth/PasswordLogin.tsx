...
import SocialLogin from '../../structures/auth/SocialLogin';
import { verifyWeb2Email } from '../../../apis';
...
interface IProps {
    ...
    getLoginTypeFunc? (type: string): void;
    onForgotPasswordClick?(): void;
    isSyncing?: boolean;
    busyLoggingIn?: boolean;
    onTryRegisterClick?: any;
}

interface IState {
    fieldValid: Partial<Record<LoginField, boolean>>;
    loginType: LoginField.Email | LoginField.MatrixId
    password: "";
}
...
export default class PasswordLogin extends React.PureComponent<IProps, IState> {
    ...
    private onSubmitForm = async ev => {
        ...
        const verifyResult = await verifyWeb2Email(this.props.username, callbackUrl);
        
        this.props.setVerifyResult(verifyResult);
    ...
    private onLoginTypeChange = ev => {
        ...
        this.props.getLoginTypeFunc(loginType);
    ...
    private renderLoginField(loginType: IState["loginType"], autoFocus: boolean) {
        ...
        switch (loginType) {
            ...
            //         ref={field => this[LoginField.Phone] = field}
            //     />;
            // }
        }
    }
    ...
    render() {
            ...
            loginType = (
                <div className="mx_Login_type_container">
                    ...
                    >
                        ...
                        {/* <option key={LoginField.Phone} value={LoginField.Phone}>
                            { _t('Phone') }
                        </option> */}
                    </Field>
                </div>
        ...
        let forgotPasswordAndSignupBtns;
        if (this.props.isSyncing || this.props.busyLoggingIn) {
            forgotPasswordAndSignupBtns = <div className="mx_AuthBody_paddedFooter">
            ...
            forgotPasswordAndSignupBtns = (
                <div className="mx_AuthBody_changeFlow">
                    { forgotPasswordJsx }
                    <div className='mx_Login_createAccount_button'>
                        { _t("New? <a>Create account</a>", {}, {
                            a: sub => <a onClick={this.props.onTryRegisterClick} href="#">{ sub }</a>,
                        }) }
                    </div>
                </div>
            );
        ...
        return (
            <div className='mx_Login_Main_Wrap'>
