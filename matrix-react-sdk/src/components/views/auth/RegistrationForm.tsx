...
export default class RegistrationForm extends React.PureComponent<IProps, IState> {
    ...
    private authStepIsRequired(step: string) {
        if(step === "m.login.email.identity") return true //required email
    ...
    render() {
        const registerButton = (
            <input className="mx_Login_submit mt-4" type="submit" value={_t("Register")} disabled={!this.props.canSubmit} />
        );
        ...
        return (
            <div className='mx_Signup_Main_Wrap'>
                <div className='common-badge bg-light-purple my-4'>Legacy</div>
