...
const NewRoomIntro = () => {
    ...
    if (dmPartner) {
        ...
        const roomNameClassName = classNames("");
        body = <React.Fragment>
            ...
            <div className="mx_NewRoomIntro_detail">
                <h2 className={roomNameClassName}>
                    <span>
                        { room.name }
                    </span>
                    { verifiedBadge }
                ...
                <p>{ _t("This is the beginning of your direct message history with <displayName/>.", {}, {
                    displayName: () => <b className={roomNameClassName}>{ displayName }</b>,
                }) }</p>
                { caption && <p>{ caption }</p> }
            </div>
        </React.Fragment>;
