...
import GIFPickerContext from './GIFPickerContext'
...
import UserCoinWallet from './UserCoinWallet';
...
export default class MessageComposer extends React.Component<IProps, IState> {
    ...
    private invisibleComposerInput: SendMessageComposer;
    ...
    private sendGIF = (gif: IGif, e: React.SyntheticEvent) => {
        e.preventDefault();
        ...
        this.invisibleComposerInput.onAction({
            action: Action.ComposerInsert,
            text: `<gif>${gif.id}</gif>`,
        })

        this.invisibleComposerInput.sendMessage();
    };
    ...
    render() {
        const controls = [
            ...
            // this.props.room.summaryHeroes ?
            //     <E2EIcon key="e2eIcon" status={"normal"} className="mx_MessageComposer_e2eIcon" /> :
            //     null,
        ];
        ...
        if (!this.state.tombstone && this.state.canSendMessages) {
            // if (!this.state.haveRecording) {
                controls.push(
                    ...
                    <div className='mx_messageInput_and_tools' key={"mx_messageInput_and_tools"}>
                        <div style={{ display: 'none' }}>
                            <SendMessageComposer
                                ref={(c) => this.invisibleComposerInput = c}
                                key="controls_input"
                        ...
                        <SendMessageComposer
                            ...
                            disabled={this.state.haveRecording}
                        />
                        <div className='mx_messageInput_tools' key={'mx_messageInput_tools'}>
                            <UploadButton 
                                key="controls_upload" 
            ...
            if (!this.state.isComposerEmpty || this.state.haveRecording) {
                ...
                controls.push(
                    <UserCoinWallet
                        ...
                        sentTipAmount={this.props.sentTipAmount}
        ...
        const isHideControls = (this.props.isMobileView && !this.props.isHiddenLeftPanel)
        ...
        return (
            <div className="mx_MessageComposer mx_GroupLayout">
                ...
                <div className="mx_MessageComposer_wrapper">
                    ...
                    <div className='mx_MessageComposer_main_body'>
                        <div className={`mx_MessageComposer_row ${isHideControls? "hide-controls" : ""}`}>
                            { controls }
                        </div>                        
                    </div>
                </div>
