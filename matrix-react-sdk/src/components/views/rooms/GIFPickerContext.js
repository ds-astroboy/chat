...
const PERSISTED_ELEMENT_KEY = "GIFPickerContext";

@replaceableComponent("views.rooms.GIFPickerContext")
export default class GIFPickerContext extends React.PureComponent {
    ...
    async _removeStickerpickerWidgets() {
        ...
        console.log('Removing GIFPickerContext widgets');
    ...
    _updateWidget() {
        ...
        if (!stickerpickerWidget) {
            GIFPickerContext.currentWidget = null;
            this.setState({ stickerpickerWidget: null, widgetId: null });
            return;
        }

        const currentWidget = GIFPickerContext.currentWidget;
        let currentUrl = null;
        ...
        GIFPickerContext.currentWidget = stickerpickerWidget;
        this.setState({
            stickerpickerWidget,
    ...
    render() {
        ...
        if (this.state.showStickers) {
            ...
            >
                <GIFPicker onChoose={this.props.addEmoji} onSelectGIF={this.props.onSelectGIF} showQuickReactions={true}/>
            </ContextMenu>;
        } else {
            ...
            stickersButton =
                <AccessibleTooltipButton
                    ...
                    className="mx_MessageComposer_button mx_MessageComposer_gif"
