...
export default class BasicMessageEditor extends React.Component<IProps, IState> {
    ...
    private onKeyDown = async (event: React.KeyboardEvent) => {
    ...
    render() {
        ...
        const classes = classNames("mx_BasicMessageComposer_input", "mx_BasicMessageComposer_inputEmpty", {
