...
const PERSISTED_ELEMENT_KEY = "EmojiPickerContext";

@replaceableComponent("views.rooms.EmojiPickerContext")
export default class EmojiPickerContext extends React.PureComponent {
    ...
    async _removeStickerpickerWidgets() {
        ...
        console.log('Removing EmojiPickerContext widgets');
    ...
    _updateWidget() {
        ...
        if (!stickerpickerWidget) {
            EmojiPickerContext.currentWidget = null;
            this.setState({ stickerpickerWidget: null, widgetId: null });
            return;
        }

        const currentWidget = EmojiPickerContext.currentWidget;
        let currentUrl = null;
        ...
        EmojiPickerContext.currentWidget = stickerpickerWidget;
        this.setState({
            stickerpickerWidget,
    ...
    render() {
        ...
        if (this.state.showStickers) {
            ...
            >
                <EmojiPicker onChoose={this.props.addEmoji} showQuickReactions={true}/>
            </ContextMenu>;
        } else {
