    ...
    render() {
        ...
        if (
            ...
            profileSettingsButtons = (
                <div className="mx_ProfileSettings_buttons d-flex justify-content-evenly align-items-center">
                    <AccessibleButton
        ...
        return (
            ...
            >
                <input
                    ...
                    accept="image/*"
                />
                <div className="mx_ProfileSettings_profile mx_RoomProfileSettings_profile">
                    <AvatarSetting
                    ...
                    />
                    <div className="mx_ProfileSettings_controls mt-4">
                        <Field
                            label={_t("Room Name")}
                            type="text"
