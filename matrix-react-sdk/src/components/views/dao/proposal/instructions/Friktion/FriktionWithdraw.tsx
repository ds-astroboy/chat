...
import { getFriktionWithdrawSchema } from '../../../../../../utils/vote/validations'
import useGovernanceAssets from '../../../../../../hooks/useGovernanceAssets'
import { Governance } from '@solana/spl-governance'
import { ProgramAccount } from '@solana/spl-governance'
import GovernedAccountSelect from '../../GovernedAccountSelect'
import { getFriktionWithdrawInstruction } from '../../../../../../utils/vote/instructions/Friktion'
  ...
  return (
    <>
      ...
      <select
        ...
        onChange={(e) => {
          const volt = friktionVolts?.find((x) => x.voltVaultId === e.target.value)
          setFormErrors({})
          setForm({
            ...form,
            voltVaultId: e.target.value,
      ...
      >
        {friktionVolts
          ...
          .map((value) => (
            <option key={value.voltVaultId} value={value.voltVaultId}>
