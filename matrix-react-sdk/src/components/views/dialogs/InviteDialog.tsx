...
import { trimUserId } from '../../../hooks/trimString';
        ...
        return (
            <div className='mx_InviteDialog_roomTile' onClick={this.onClick}>
                ...
                <span className="mx_InviteDialog_roomTile_nameStack">
                    ...
                    <div className='mx_InviteDialog_roomTile_userId'>{ typeof caption === "string"? trimUserId(caption): caption }</div>
                </span>
                { timestamp }
            </div>
        );
...
export default class InviteDialog extends React.PureComponent<IInviteDialogProps, IInviteDialogState> {
    ...
    private renderLinkSection() {
        ...
        return (
            <div className='mx_InviteDialog_linkSection'>
                <div className='mx_InviteDialog_linkSection_title dark bold'>
                    Sharing is caring
                </div>
                <div className='d-flex justify-content-between align-items-center'>
                    <div className='mx_InviteDialog_linkSection_groupLink'>
                        <Field
                            label={"Group Link"}
                            value={this.props.roomId}
                            className="mx_InviteDialog_linkSection_groupLink_field"
                            disabled={true}
                        />
                        <div className='mx_InviteDialog_linkSection_groupLink_buttonGroup d-flex'>
                            <AccessibleButton 
                    ...
                    <div className='mx_InviteDialog_linkSection_qrCode'>
                        <img src={require("../../../../res/img/cafeteria-qrcode.png")} />
                    </div>
                </div>
            </div>
        )
