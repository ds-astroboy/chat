...
export default (props) => {
    ...
    const onFinished = async(sendFeedback) => {
        if (hasFeedback && sendFeedback) {
            ...
            const success = await postFeedback(comment, rating, accessToken);
            if(!success) {
                props.alert.error("Error! Please try again.")
                return props.onFinished();
            }
            props.alert.success("Thanks for your feedback!")
        }
        props.onFinished();
    };
