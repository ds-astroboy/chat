...
export default class BaseDialog extends React.Component {
    ...
    render() {
        ...
        if (this.props.hasCancel) {
            cancelButton = (
                <AccessibleButton onClick={this._onCancelClick} className="mx_Dialog_cancelButton" id="mx_Dialog_cancelButton" aria-label={_t("Close dialog")} />
            );
        }
