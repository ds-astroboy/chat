...
import RewardsTap from '../settings/tabs/user/RewardsTab';
...
export enum UserTab {
    ...
    Help = "USER_HELP_TAB",
    Advanced = "USER_ADVANCED_TAB",
    Rewards = "USER_Rewards_TAB"
}
...
export default class UserSettingsDialog extends React.Component<IProps, IState> {
    ...
    private getTabs() {
        ...
        tabs.push(new Tab(
            UserTab.Rewards,
            "Rewards",
            "mx_UserSettingsDialog_rewardsIcon",
            <RewardsTap />,
        ));
        ...
        //     UserTab.Advanced,
        //     _td("Advanced"),
        //     "mx_UserSettingsDialog_advancedIcon",
        //     <AdvancedUserSettingsTab />,
        // ));
