...
import RoomSpecialSettings from "../../../room_settings/RoomSpecialSettings"
import * as sdk from "../../../../..";
    ...
    render() {
        ...
        return (
            <div className="mx_SettingsTab mx_GeneralRoomSettingsTab">
                ...
                <span className='mx_SettingsTab_subheading'>{ "Leave Group" }</span>
                <div className='mx_SettingsTab_section'>
                    <AccessibleButton kind='danger' onClick={this._onLeaveClick} disabled>
                        { 'Leave Group' }
                    </AccessibleButton>
                </div>
            </div>
