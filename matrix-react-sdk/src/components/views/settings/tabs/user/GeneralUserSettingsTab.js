...
import WalletAddress from "../../account/WalletAddress";
import LabelledToggleSwitch from '../../../elements/LabelledToggleSwitch';
import { getPMSetting, setPMSetting } from '../../../../../apis';
...
export default class GeneralUserSettingsTab extends React.Component {
    ...
    async componentDidMount() {
        ...
        let isPMEnabled = await getPMSetting(accessToken);
        if (plaf) {
            this.setState({
                spellCheckLanguages: await plaf.getSpellCheckLanguages(),
            });
        }
        this.setState({isPMEnabled})
    }
    ...
    _onLocationChange = (newLocation) => {
        if (this.state.location === newLocation) return;
        ...
        return (
            <div className="mx_SettingsTab_section">
                <ProfileSettings 
                    ...
                    changeNftAvatarStateValue={this.props.changeNftAvatarStateValue}
                    changeSavingAvatarStateValue={this.props.changeSavingAvatarStateValue}
                    changeAdjustedAvatarStateValue={this.props.changeAdjustedAvatarStateValue}
                />
            </div>
        );
    }
    ...
    _renderWalletSection() {
        ...
        let solanaPrimaryLabel;
        let ethereumPrimaryLabel;
        if(primaryWallet) {
            primaryWallet = JSON.parse(primaryWallet);
            switch(primaryWallet.protocol) {
                case BLOCKCHAINNETWORKS.Solana:
                    solanaPrimaryLabel = "(Primary Wallet)";
                    break;
                case BLOCKCHAINNETWORKS.Ethereum:
                    ethereumPrimaryLabel = "(Primary Wallet)";
                    break;
            }
        }
        ...
        return (
            <>
                <div className="mx_SettingsTab_section mx_GeneralUserSettingsTab_accountSection d-flex">
                    <div className='mx_SettingsTab_section_logo'>
                        <img src={require("../../../../../../res/img/solana-wallet.png")} />
                    </div>
                    <div className='mx_SettingsTab_section_wrap'>
                        <span className="mx_SettingsTab_subheading">Solana Wallet <span className='t-regular grey'>{solanaPrimaryLabel}</span></span>
                        <WalletAddress protocol='solana' wallets={this.props.wallets}/>
                    </div>
                </div>
                <div className="mx_SettingsTab_section mx_GeneralUserSettingsTab_accountSection d-flex">
                    <div className='mx_SettingsTab_section_logo'>
                        <img src={require("../../../../../../res/img/currency/ethereum.svg")} />
                    </div>
                    <div className='mx_SettingsTab_section_wrap'>
                        <span className="mx_SettingsTab_subheading">Ethereum Wallet <span className='t-regular grey'>{ethereumPrimaryLabel}</span></span>
                        <WalletAddress protocol='ethereum' wallets={this.props.wallets}/>
                    </div>
                </div>
            </>
        );
    ...
    _renderAccountSection() {
        ...
        let passwordChangeForm = (
            <ChangePassword
                className="mx_GeneralUserSettingsTab_changePassword mt-4"
                rowClassName="mt-4"
                buttonClassName="common-btn bg-green small-shadow px-4 py-0 mt-4"
                buttonKind="primary"
        ...
        if (SettingsStore.getValue(UIFeature.ThirdPartyID) &&
            ...
            //     />;
            threepidSection = <div>
                <span className="mx_SettingsTab_subheading">{ "Email" }</span>
                { emails }
        ...
        // <div className="mx_SettingsTab_section d-flex mx_GeneralUserSettingsTab_accountSection">
        //     <div className='mx_SettingsTab_section_logo'>
        //         <img src={require("../../../../../../res/img/private-group+password+encrypted-messages.png")}/>
        //     </div>
        //     <div className='mx_SettingsTab_section_wrap'>
        //         <span className="mx_SettingsTab_subheading">{ "Password" }</span>
        ...
        return (
            <>
                <div className="mx_SettingsTab_section d-flex mx_GeneralUserSettingsTab_accountSection">
                    <div className='mx_SettingsTab_section_logo'>
                        <img src={require("../../../../../../res/img/email.png")}/>
                    </div>
                    <div className='mx_SettingsTab_section_wrap'>
                        { threepidSection }
                    </div>
    ...
    _renderPMTagSection() {
        const onPMSettingChange = (isPMEnabled) => {
            const accessToken = MatrixClientPeg.get().getAccessToken();
            ;(async() => {
                let result = await setPMSetting(accessToken, isPMEnabled);
                if(result) {
                    let isPMEnabled = await getPMSetting(accessToken);
                    this.setState({isPMEnabled})
                }
        ...
        return (
            <div className="mx_SettingsTab_section d-flex">
                <div className='mx_SettingsTab_section_logo'>
                    <img src={require("../../../../../../res/img/private-message.png")}/>
                </div>
                <div className='mx_SettingsTab_section_wrap'>
                    <span className="mx_SettingsTab_subheading">{ "Private Message Settings" }</span>
                    <LabelledToggleSwitch
                        label={"Do you want to recieve PMs from others?"}
                        onChange={onPMSettingChange}
                        value={this.state.isPMEnabled}
                        className="mx_SettingsTab_PMSettingToggle"
                    />
                    {/* {pointBarrierLabel} */}
                    {/* {pointBarrierField} */}
                </div>
    ...
    _renderLanguageSection() {
        ...
        return (
            <div className="mx_SettingsTab_section d-flex">
                <div className='mx_SettingsTab_section_logo'>
                    <img src={require("../../../../../../res/img/languages.png")}/>
                </div>
                <div className='mx_SettingsTab_section_wrap'>
                    <span className="mx_SettingsTab_subheading">{ "Language" }</span>
                    <LanguageDropdown
                        className="mx_GeneralUserSettingsTab_languageInput mt-4"
    ...
    _renderLocationSection() {
        return (
            <div className="mx_SettingsTab_section d-flex">
                <div className='mx_SettingsTab_section_logo'>
                    <img src={require("../../../../../../res/img/location.png")}/>
                </div>
                <div className='mx_SettingsTab_section_wrap'>
                    <span className="mx_SettingsTab_subheading">Location (optional)</span>
                    <LocationDropdown
                        className="mx_GeneralUserSettingsTab_locationInput mt-4"
    ...
    _renderManagementSection() {
        ...
        return (
            <div className="mx_SettingsTab_section d-flex">
                <div className='mx_SettingsTab_section_logo'>
                    <img src={require("../../../../../../res/img/account-management.png")}/>
                </div>
                <div className='mx_SettingsTab_section_wrap'>
                    <span className="mx_SettingsTab_subheading">{ _t("Account management") }</span>
                    <span className="mx_SettingsTab_subsectionText mt-4">
                        { _t("Deactivating your account is a permanent action - be careful!") }
                    </span>
                    <AccessibleButton onClick={this._onDeactivateClicked} kind="danger" className='common-btn small-shadow px-4 py-0'>
