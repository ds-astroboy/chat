...
export class ContextMenu extends React.PureComponent<IProps, IState> {
    ...
    protected renderMenu(hasBackground = this.props.hasBackground) {
        ...
        const menuClasses = classNames({
            ...
            'mx_ContextualMenu_left': this.props.isLeft === undefined? !hasChevron && position.left : this.props.isLeft,
            'mx_ContextualMenu_right': this.props.isRight === undefined? !hasChevron && position.right : this.props.isRight,
            'mx_ContextualMenu_top': this.props.isTop === undefined? !hasChevron && position.top : this.props.isTop,
            'mx_ContextualMenu_bottom': this.props.isBottom === undefined? !hasChevron && position.bottom : this.props.bottom,
