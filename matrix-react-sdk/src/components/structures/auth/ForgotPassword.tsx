...
export default class ForgotPassword extends React.Component<IProps, IState> {
    ...
    private onSubmitForm = async (ev: React.FormEvent): Promise<void> => {
        ...
        if (!this.state.email) {
            ...
            Modal.createTrackedDialog('Forgot Password Warning', '', QuestionDialog, {
                title: _t('Confirm'),
                className: "mx_ForgotDialog_confirm",
                description:
                    <div>
    ...
    renderForgot() {
        ...
        return <div>
            ...
            /> */}
            <div className="mx_ForgotPassword_wrap">
            ...
            <a className="mx_AuthBody_changeFlow t-green t-hover-purple" onClick={this.onLoginClick} href="#">
                { _t('Sign in instead') }
            </a>
        </div>;
    }
    ...
    render() {
        ...
        return (
            <AuthPage>
                <AuthBody>
                    <div className='mx_AuthBody_container'>
                        <h2 className='py-3 t-white'> { _t('Set a new password') } </h2>
                        <div className='mx_AuthBody_main_wrap pb-4'>
                            { resetPasswordJsx }
                        </div>
                    </div>
                </AuthBody>
