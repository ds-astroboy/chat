...
import RoomAppStore from '../views/right_panel/RoomAppStore';
import DMRoomMap from '../../utils/DMRoomMap';
import { MatrixClientPeg } from '../../MatrixClientPeg';
import DonatorList from '../views/right_panel/DonatorList';
...
export default class RightPanel extends React.Component<IProps, IState> {
    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            isPrivateMessage: !!DMRoomMap.shared().getUserIdForRoomId(this.props.room.roomId)
        };
    ...
    render() {
        ...
        if(this.state.isPrivateMessage) {
            const roomMembers = this.props.room.getMembers();
        ...
        switch (this.state.phase) {
            ...
            case RightPanelPhases.RoomSummary:
                if(this.state.isPrivateMessage) {
                    panel = <UserInfo
                        ...
                        key={privateMember.userId}
                        phase={RightPanelPhases.GroupMemberInfo}
                        onClose={this.onClose} 
                        setSentTipAmount={this.props.setSentTipAmount}/>;
                    }
                else {
            ...
            case RightPanelPhases.Widget:
                ...
                break;
            case RightPanelPhases.RoomAppStore:
                panel = <RoomAppStore room={this.props.room} onClose={this.onClose} setLottieBgUrl={this.props.setLottieBgUrl}/>;
                break;
            case RightPanelPhases.RoomDonatorList:
                panel = <DonatorList/>
        }
