...
import OnlineMemberList from '../views/rooms/OnlineMemberList';
import Spinner from "../views/elements/Spinner";
import SearchBox from "../structures/SearchBox";
import AccessibleButton from '../views/elements/AccessibleButton';
import EntityTile from "../views/rooms/EntityTile";
...
interface IProps {
    roomId: string;
    members: VoteMemberResult[] | VoteMember[]
}
...
@replaceableComponent("views.rooms.VoteMemberList")
export default class VoteMemberList extends React.Component<IProps, IState> {
    ...
    private showMoreJoinedVoteMemberList = (): void => {
        this.setState({
            truncateAtJoined: this.state.truncateAtJoined + SHOW_MORE_INCREMENT,
        });
    };

    private showMoreInvitedVoteMemberList = (): void => {
        this.setState({
    ...
    private makeMemberTiles(members: Array<RoomMember | MatrixEvent>) {
        return members.map((m) => {
            if (m instanceof RoomMember) {
                ...
                if(m.powerLevel == 100 || m.user.presence == "online" || m.userId == userId) {
    ...
    render() {
        ...
        const searchbar = (
            <SearchBox
                className="mx_VoteMemberList_query mx_textinput_icon mx_textinput_search"
        ...
        >
            <div className="mx_VoteMemberList_wrapper">
                <VoteMembers members={this.props.members}/>
            </div>
        </BaseCard>;
    }
}
