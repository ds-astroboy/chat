import { getAccountName, WSOL_MINT } from '../../components/views/dao/instructions/tools'
import { BN } from '@project-serum/anchor'
import { PublicKey } from '@solana/web3.js'
import { getMintDecimalAmountFromNatural } from '../../tools/sdk/units'
import BigNumber from 'bignumber.js'
import { Account, AccountType } from '../../stores/vote/useGovernanceAssetsStore'
...
const getName = (governedAccountTokenAccount: GovernedTokenAccount) => {
  const tokenAccName = governedAccountTokenAccount.transferAddress
