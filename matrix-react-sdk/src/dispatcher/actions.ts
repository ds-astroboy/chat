...
export enum Action {
    ...
    ViewTransactions = "view_user_transactions",
    ...
    /**
     * Amount input Dialog Space for Gift and Tip.
     */
    InputTokenAmt = "input_token_amt",

    /**
     * VOTE space. (Cafeteria DAO).
     */
    VotePage = "show_vote_page"
}
