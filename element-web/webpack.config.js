    ...
    return {
        ...
        module: {
            ...
            rules: [
                ...
                // {
                //     test: /\.js$/,
                //     include: path.resolve(require.resolve("matrix-react-sdk/package.json"), '..', 'node_modules/@ensdomains'),
                //     loader: 'babel-loader',
                //     options: {
                //         cacheDirectory: true,
                //     },
                ...
                {
                    test: /\.(gif|png|svg|ttf|otf|woff|woff2|xml|ico|jpg)$/,
