...
export default class VectorAuthPage extends React.PureComponent {
    ...
    //     VectorAuthPage.welcomeBackgroundUrl = "themes/element/img/backgrounds/bg-graphics.svg";
    ...
    render() {
        ...
        const pageStyle = {
            ...
            background: `linear-gradient(200.79deg, #4630A0 7.33%, #2F6FA0 58.49%, #09D8A2 100%)`,
            // backgroundColor: "#46309f",
        ...
        return (
            <div className="mx_AuthPage" style={pageStyle}>
                <div className='mx_AuthPage_bg'>
                    <img className='mx_AuthPage_bg_main' src={require("../../../../res/welcome/images/Illustration.svg")}/>
                    <div className='mx_AuthPage_bg_logo'>
                        <img src={require("../../../../res/welcome/images/auth-logo.svg")}/>
                    </div>
                </div>
