...
export default class VectorEmbeddedPage extends EmbeddedPage {
    ...
    translate(s: string) {
        ...
        s = s.replace(/\[matrix\]/, '<a href="https://cafeteria.gg" target="_blank" rel="noreferrer noopener"><img width="79" height="34" alt="Matrix" style="padding-left: 1px;vertical-align: middle" src="welcome/images/matrix.svg"/></a>');
        return s;
    }
}
