    ...
    return (
        <div className="mx_WalletSignupButtonGroup">
            ...
            <div className='mx_WalletSignupButtonGroup_body mt-4'>                
                ...
                <AptosWalletAdapterProvider plugins={[new PetraWallet(), new FewchaWallet(), new MartianWallet(), new NightlyWallet(), 
                                                    new PontemWallet(), new RiseWallet(), new TrustWallet(), new WelldoneWallet(),]}>
                    <WalletSelector/>
