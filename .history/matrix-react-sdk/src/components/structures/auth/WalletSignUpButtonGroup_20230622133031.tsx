...
const WalletSignupButtonGroup: FC<IProps> = (props) => {
    ...
    const clickAptosWalletButton = () => {
        ...
        document.getElementById("wallet-aptos-button").click();
        // return <WalletSelector/>;
    }
    ...
    return (
        <div className="mx_WalletSignupButtonGroup">
            ...
            <div className='mx_WalletSignupButtonGroup_body mt-4'>                
                ...
                <AptosWalletAdapterProvider plugins={[new FewchaWallet(), new MartianWallet(), new MSafeWalletAdapter(), new NightlyWallet(), new OpenBlockWallet(), new PetraWallet(), 
                                                    new PontemWallet(), new RiseWallet(), new ToknPocketWallet(), new TrustWallet(), new WelldoneWallet(),]}>
                    <WalletSelector/>
