...
import { WalletConnector, WalletButton } from "@aptos-labs/wallet-adapter-mui-design";
...
const ConnectButton = props => {
    ...
    return (
        <>
            ...
            <WalletDialogProvider>
                <WalletMultiButton id="wallet-aptos-button"/>
                <WalletDisconnectButton id="wallet-aptos-disconnect-button"/>
            </WalletDialogProvider>
