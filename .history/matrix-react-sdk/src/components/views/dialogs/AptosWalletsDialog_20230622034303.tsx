...
import { useWallet as aptosWallet, AptosWalletAdapterProvider } from "@aptos-labs/wallet-adapter-react";
            ...
            <Modal.Body>
                <AccessibleButton
                    ...
                    onClick={() => {
                        ...
                        aptosWallet.
                        aptosWallet.connect(PetraWalletName)
